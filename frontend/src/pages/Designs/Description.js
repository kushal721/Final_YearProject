      ...
      const response = await fetch(
        "http://localhost:4000/api/favorites/addFavorites",
        {
          ...
          headers: {
            ...
            Authorization: `Bearer ${user.userId}`, // Replace YOUR_AUTH_TOKEN with the actual authentication token
          },
          body: JSON.stringify({ userId: user.userId, designId: id }), // Use the design ID from useParams
        }
      );
